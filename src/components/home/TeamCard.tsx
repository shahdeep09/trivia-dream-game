      ...
      <CardContent>
        <div className="flex justify-between items-center">
          <div className="space-y-1">
            ...
            <p className="text-sm"><span className="font-medium text-white">Game Points:</span> <span className="font-bold text-white">{team.points || 0}</span></p>
            <p className="text-sm"><span className="font-medium text-white">Bonus Points:</span> <span className="font-bold text-white">{team.bonusPoints || 0}</span></p>
